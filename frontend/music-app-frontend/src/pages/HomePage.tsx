    ...
    <div className="min-h-screen bg-black">
      ...
      {showSettings && (
        <div className="fixed inset-0 bg-black/50 z-50" onClick={() => setShowSettings(false)}>
          <div className="absolute right-0 top-0 h-full w-80 bg-neutral-900 shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="p-6">
        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center px-4">
          <div className="bg-neutral-900 rounded-2xl p-8 max-w-md w-full">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Deactivate Account?</h2>
              <p className="text-gray-400">
                Your account will be scheduled for permanent deactivation in 7 days. 
                You can cancel this by logging in within that period.
              </p>
            </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-6 mb-6">
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                <h3 className="text-sm font-medium text-yellow-400">Verify your email</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 p-4 bg-neutral-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-white font-medium font-mono text-sm">{user?.userId}</p>
              </div>
            </div>
          </div>
        </div>
